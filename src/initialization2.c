...
/*   Updated: 2019/09/23 21:16:55 by boris            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/filler.h"

int		init_piece(t_filler *data, char *line)//проверенно
{
...
int		read_piece(t_filler *data)//проверенно
{
...
int		fill_piece(t_filler *data, char *line)//проверенно
{
	int i;
...
void	fill_position(t_filler *data, int y, int x, long int min)//проверено
{
